...
class DartsMatchStub(object):
    ...
    def __init__(self, channel):
        ...
        self.WatchMatch = channel.unary_unary(
...
def add_DartsMatchServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'WatchMatch': grpc.unary_unary_rpc_method_handler(
                    servicer.WatchMatch,
...
class DartsMatch(object):
    ...
    def WatchMatch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/app.DartsMatch/WatchMatch',
